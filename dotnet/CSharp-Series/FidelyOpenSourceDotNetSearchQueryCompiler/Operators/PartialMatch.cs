...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class PartialMatch<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public PartialMatch(string symbol) : this(symbol, false)
        {
        }
        ...
        public PartialMatch(string symbol, bool ignoreCase) : this(symbol, ignoreCase, OperatorIndependency.Strong, null)
        {
        }
        ...
        public PartialMatch(string symbol, bool ignoreCase, OperatorIndependency independency, string description) : base(symbol, independency, description)
        {
        ...
        {
            return new PartialMatch<T>(Symbol, _ignoreCase, Independency, Description);
        }
