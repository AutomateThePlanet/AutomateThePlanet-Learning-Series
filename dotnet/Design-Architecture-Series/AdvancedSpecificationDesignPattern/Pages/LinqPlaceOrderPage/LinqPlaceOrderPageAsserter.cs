// <copyright file="LinqPlaceOrderPageAsserter.cs" company="Automate The Planet Ltd.">
...
{
    public static void AssertPromoCodeLabel(this PlaceOrderPage.PlaceOrderPage page, string promoCode)
    {
