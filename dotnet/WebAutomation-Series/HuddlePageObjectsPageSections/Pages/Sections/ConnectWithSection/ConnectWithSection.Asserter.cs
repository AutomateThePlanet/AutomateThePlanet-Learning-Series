// <copyright file="ConnectWithSection.Asserter.cs" company="Automate The Planet Ltd.">
...
{
    public partial class ConnectWithSection
    {
        public void AssertGoogleButtonVisible() => Assert.IsTrue(GoogleButton.Displayed);
