// <copyright file="AssertedPage.cs" company="Automate The Planet Ltd.">
...
namespace HuddlePageObjectsPartialClassesBaseClasses.Core
{
    public abstract class AssertedPage : Page
    {
        protected AssertedPage(IWebDriver driver) : base(driver)
        {
