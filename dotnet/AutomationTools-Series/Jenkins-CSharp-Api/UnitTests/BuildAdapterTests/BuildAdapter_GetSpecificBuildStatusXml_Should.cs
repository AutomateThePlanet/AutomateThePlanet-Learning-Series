...
// <copyright file="BuildAdapter_GetSpecificBuildStatusXml_Should.cs" company="Automate The Planet Ltd.">
...
{
    [TestClass]
    public class BuildAdapter_GetSpecificBuildStatusXml_Should
    {
        [TestMethod]
