...
namespace PerfectSystemTestsDesign.Pages.ShippingAddressPage
{
    public partial class ShippingAddressPage : BasePage
    {
        ...
        public void FillShippingInfo(PerfectSystemTestsDesign.Data.ClientPurchaseInfo clientInfo)
        {
            this.FillAddressInfoInternal(clientInfo);
        }

        public void ClickDifferentBillingCheckBox(PerfectSystemTestsDesign.Data.ClientPurchaseInfo clientInfo)
        {
        ...
        public void FillBillingInfo(PerfectSystemTestsDesign.Data.ClientPurchaseInfo clientInfo)
        {
            if (clientInfo.BillingInfo != null)
            {
                this.FillAddressInfoInternal(clientInfo);
        ...
        private void FillAddressInfoInternal(PerfectSystemTestsDesign.Data.ClientPurchaseInfo clientInfo)
        {
