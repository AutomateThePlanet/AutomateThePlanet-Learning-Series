...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class PrefixSearch<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public PrefixSearch(string symbol) : this(symbol, false)
        {
        }
        ...
        public PrefixSearch(string symbol, bool ignoreCase) : this(symbol, ignoreCase, OperatorIndependency.Strong, null)
        {
        }
        ...
        public PrefixSearch(string symbol, bool ignoreCase, OperatorIndependency independency, string description) : base(symbol, independency, description)
        {
        ...
        {
            return new PrefixSearch<T>(Symbol, _ignoreCase, Independency, Description);
        }
