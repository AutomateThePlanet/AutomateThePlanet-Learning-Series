// <copyright file="TestsExceptionsAnalyzerContext[T,T1,T2].cs" company="Automate The Planet Ltd.">
...
{
    public class TestsExceptionsAnalyzerContext<THandler1, THandler2, THandler3> : TestsExceptionsAnalyzerContext<THandler1, THandler2>
        ...
        where THandler3 : Handler, new()
    {
        ...
        {
            AddHandlerInfrontOfChain<THandler3>();
        }
    }
}