// <copyright file="ElementFinderServiceEvenHandlers.cs" company="Automate The Planet Ltd.">
...
namespace HybridTestFramework.UITests.Selenium.Events
{
    public abstract class ElementFinderServiceEvenHandlers
    {
        ...
        {
            ElementFinderService.ReturningWrappedElement += ReturningWrappedElementEventHandler;
        }
