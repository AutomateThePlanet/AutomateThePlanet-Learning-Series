...
namespace SimpleFactoryDesignPatternReverseProxy
{
    public static class ProxyService
    {
        ...
        public static string CurrentProxyIpHost { get; set; }
        public static int CurrentProxyIpPort { get; set; }
        ...
        public static string GetNewProxyIp()
        {
            ...
            CurrentProxyIpHost = CurrentProxyIp.Split(':').First();
            CurrentProxyIpPort = int.Parse(CurrentProxyIp.Split(':').Last());
