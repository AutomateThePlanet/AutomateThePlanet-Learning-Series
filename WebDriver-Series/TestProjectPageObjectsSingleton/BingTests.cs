...
namespace TestProjectPageObjectsSingleton
{
    ...
    public class BingTests
    {
        ...
        {
            Singleton.BingMainPage.GetInstance().Navigate();
            Singleton.BingMainPage.GetInstance().Search("Automate The Planet");

            Singleton.BingMainPage.GetInstance().AssertResultsCount("236,000 RESULTS");
        }
    }
}
