...
{
    [TestFixture]
    public class SuffixSearchTest
    {
        private SuffixSearch<CustomEntity> testee;


        [SetUp]
        public void SetUp()
        {
            testee = new SuffixSearch<CustomEntity>("=:");
        }
        ...
        [TestCase("ABC", "bc", false, Result = false)]
        ...
        public bool CompareShouldBeAffectedIgnoreCase(string left, string right, bool ignoreCase)
        {
            ...
            var result = new SuffixSearch<CustomEntity>("=:", ignoreCase).Compare(expression, OperandBuilder.BuildUp(left), OperandBuilder.BuildUp(right));
            return (bool)Expression.Lambda(result.Expression).Compile().DynamicInvoke();
        }
        ...
        private class TestCaseDataGenerator : BaseTestCaseDataGenerator
        {
            ...
            {
                yield return BuildUpTestCaseData(123m, 3m).Returns(true);
                ...
                yield return BuildUpTestCaseData(123m, "3").Returns(true);
                yield return BuildUpTestCaseData(123m, "2").Returns(false);

                yield return BuildUpTestCaseData(new Guid("C513D666-06BC-4136-B32D-7818AF4B34B3"), 3m).Returns(true);
                yield return BuildUpTestCaseData(new Guid("C513D666-06BC-4136-B32D-7818AF4B34B3"), 4m).Returns(false);
                ...
                yield return BuildUpTestCaseData(new Guid("C513D666-06BC-4136-B32D-7818AF4B34BC"), "-7818af4b34bc").Returns(true);
                ...
                yield return BuildUpTestCaseData(new DateTime(2011, 1, 1), "00 AM").Returns(true);
                yield return BuildUpTestCaseData(new DateTime(2011, 1, 1), "2011").Returns(false);
                ...
                yield return BuildUpTestCaseData(DateTimeOffset.Parse("2011/1/1"), "+09:00").Returns(true);
                yield return BuildUpTestCaseData(DateTimeOffset.Parse("2011/1/1"), "AM").Returns(false);

                yield return BuildUpTestCaseData(TimeSpan.FromDays(1), 0m).Returns(true);
                ...
                yield return BuildUpTestCaseData(TimeSpan.FromDays(1), "1.").Returns(false);

                yield return BuildUpTestCaseData("123", 3m).Returns(true);
                yield return BuildUpTestCaseData("___ 123 ___", 3m).Returns(false);
                ...
                yield return BuildUpTestCaseData("abc", "c").Returns(true);
                yield return BuildUpTestCaseData("___ abc ___", "c").Returns(false);

                yield return BuildUpTestCaseData(0m).Returns(true);
