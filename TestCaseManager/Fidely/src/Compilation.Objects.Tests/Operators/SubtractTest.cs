...
namespace Fidely.Framework.Compilation.Objects.Tests.Operators
{
    ...
    {
        private Subtract testee;


        [SetUp]
        public void SetUp()
        {
            testee = new Subtract("-", 0);
        }
        ...
        private class TestCaseDataGenerator : BaseTestCaseDataGenerator
        {
            ...
            {
                yield return BuildUpTestCaseData(1m, 2m).Returns(-1m);
                ...
                yield return BuildUpTestCaseData(new DateTime(2011, 1, 1), new DateTime(2010,12,31)).Returns(TimeSpan.FromDays(1));
                ...
                yield return BuildUpTestCaseData(new DateTime(2011, 1, 1), TimeSpan.FromDays(1)).Returns(new DateTime(2010,12,31));
                ...
                yield return BuildUpTestCaseData(DateTimeOffset.Parse("2011/1/1"), DateTimeOffset.Parse("2010/12/31")).Returns(TimeSpan.FromDays(1));
                yield return BuildUpTestCaseData(DateTimeOffset.Parse("2011/1/1"), TimeSpan.FromDays(1)).Returns(DateTimeOffset.Parse("2010/12/31"));
                ...
                yield return BuildUpTestCaseData(TimeSpan.FromDays(1), TimeSpan.FromDays(1)).Returns(TimeSpan.FromDays(0));
