...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class PartialMatch<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public PartialMatch(string symbol)
            : this(symbol, false)
        {
        }
        ...
        public PartialMatch(string symbol, bool ignoreCase)
        ...
        public PartialMatch(string symbol, bool ignoreCase, OperatorIndependency independency, string description)
