...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class NotPartialMatch<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public NotPartialMatch(string symbol)
            : this(symbol, false)
        {
        }
        ...
        public NotPartialMatch(string symbol, bool ignoreCase)
        ...
        public NotPartialMatch(string symbol, bool ignoreCase, OperatorIndependency independency, string description)
        ...
        {
            return new NotPartialMatch<T>(Symbol, ignoreCase, Independency, Description);
        }
    }
}
