...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class GreaterThanOrEqual<T> : BaseBuiltInComparativeOperator<T>
    {
        /// <summary>
        /// Initializes a new instance of this class.
        /// </summary>
        /// <param name="symbol">The symbol of this operator.</param>
        public GreaterThanOrEqual(string symbol)
        ...
        public GreaterThanOrEqual(string symbol, OperatorIndependency independency, string description)
        ...
        protected internal override Expression Compare(Operand left, Operand right)
        {
            ...
            {
                result = Expression.GreaterThanOrEqual(left.Expression, right.Expression);
            }
            else
            {
