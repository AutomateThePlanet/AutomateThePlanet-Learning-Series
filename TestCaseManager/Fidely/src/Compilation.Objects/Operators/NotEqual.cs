...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class NotEqual<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public NotEqual(string symbol, bool ignoreCase)
        ...
        public NotEqual(string symbol, bool ignoreCase, OperatorIndependency independency, string description)
