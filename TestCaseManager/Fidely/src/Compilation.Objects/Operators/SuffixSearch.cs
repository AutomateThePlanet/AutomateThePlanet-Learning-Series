...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class SuffixSearch<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public SuffixSearch(string symbol)
            : this(symbol, false)
        {
        }
        ...
        public SuffixSearch(string symbol, bool ignoreCase)
        ...
        public SuffixSearch(string symbol, bool ignoreCase, OperatorIndependency independency, string description)
        ...
        {
            return new SuffixSearch<T>(Symbol, ignoreCase, Independency, Description);
        }
    }
}
