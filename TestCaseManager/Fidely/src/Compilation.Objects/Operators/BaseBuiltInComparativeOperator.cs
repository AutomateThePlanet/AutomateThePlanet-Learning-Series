...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public abstract class BaseBuiltInComparativeOperator<T> : ComparativeOperator, IDescribable
    {
        ...
        protected BaseBuiltInComparativeOperator(string symbol)
        ...
        protected BaseBuiltInComparativeOperator(string symbol, OperatorIndependency independency, string description)
