// <copyright file="BuildAdapter_GenerateParameterizedQueueBuildUrl_Should.cs" company="Automate The Planet Ltd.">
...
namespace JenkinsCSharpApi.UnitTests.BuildAdapterTests
{
    ...
    public class BuildAdapter_GenerateParameterizedQueueBuildUrl_Should
    {
        ...
        public void GenerateParameterizedQueueBuildUrl()
        {
            ...
            string resutedUrl = buildAdapter.GenerateParameterizedQueueBuildUrl(JenkinsTestData.JenkinsUrl, JenkinsTestData.ProjectName);

            Assert.AreEqual<string>(
                @"http://localhost:8080/job/Jenkins-CSharp-Api.Parameterized/buildWithParameters",
                resutedUrl,
        ...
        public void ThrowArgumentException_WhenIncorrectUrlIsBuilt()
        {
            ...
            buildAdapter.GenerateParameterizedQueueBuildUrl(jenkunsServerUrl, projectName);
        }
    }
}