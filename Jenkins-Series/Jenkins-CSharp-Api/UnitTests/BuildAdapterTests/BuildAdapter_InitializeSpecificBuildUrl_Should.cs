// <copyright file="BuildAdapter_InitializeSpecificBuildUrl_Should.cs" company="Automate The Planet Ltd.">
...
{
    [TestClass]
    public class BuildAdapter_InitializeSpecificBuildUrl_Should
    {
        [TestMethod]
        public void InitializeSpecificBuildUrl()
        {
            ////var httpAdapter = Mock.Create<IHttpAdapter>();
            ...
            buildAdapter.InitializeSpecificBuildUrl(string.Empty);
        }
    }
}