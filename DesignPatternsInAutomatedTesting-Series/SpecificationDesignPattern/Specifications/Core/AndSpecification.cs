// <copyright file="AndSpecification.cs" company="Automate The Planet Ltd.">
...
{
    public class AndSpecification<TEntity> : SpecificationDesignPattern.Specifications.Core.Specification<TEntity>
    {
