// <copyright file="NotSpecification.cs" company="Automate The Planet Ltd.">
...
{
    public class NotSpecification<TEntity> : AdvancedSpecificationDesignPattern.Specifications.Core.Specification<TEntity>
    {
