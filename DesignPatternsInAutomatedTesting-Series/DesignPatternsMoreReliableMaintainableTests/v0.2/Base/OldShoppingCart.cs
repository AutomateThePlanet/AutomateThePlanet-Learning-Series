...
using DesignPatternsMoreReliableMaintainableTests.Data.Second;
using DesignPatternsMoreReliableMaintainableTests.Pages.Checkout.Second;
using DesignPatternsMoreReliableMaintainableTests.Pages.Item.Second;
using DesignPatternsMoreReliableMaintainableTests.Pages.ShippingAddress.Second;
using DesignPatternsMoreReliableMaintainableTests.Pages.SignIn.Second;

namespace DesignPatternsMoreReliableMaintainableTests.Base.Second
{
