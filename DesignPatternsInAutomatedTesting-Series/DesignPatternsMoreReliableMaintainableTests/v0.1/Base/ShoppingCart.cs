...
using DesignPatternsMoreReliableMaintainableTests.Data.First;
using DesignPatternsMoreReliableMaintainableTests.Pages.Checkout.First;
using DesignPatternsMoreReliableMaintainableTests.Pages.Item.First;
using DesignPatternsMoreReliableMaintainableTests.Pages.ShippingAddress.First;
using DesignPatternsMoreReliableMaintainableTests.Pages.SignIn.First;

namespace DesignPatternsMoreReliableMaintainableTests.Base.First
{
