...
using TemplateMethodDesignPattern.Data;
using TemplateMethodDesignPattern.Pages.Checkout;
using TemplateMethodDesignPattern.Pages.Item;
using TemplateMethodDesignPattern.Pages.ShippingAddress;
using TemplateMethodDesignPattern.Pages.SignIn;

namespace TemplateMethodDesignPattern.Base
{
