...
using PatternsInAutomatedTests.Advanced.NullObject.ImmutableStrategies;

namespace PatternsInAutomatedTests.Advanced.NullObject.Tests
{
    [TestClass]
    public class AmazonPurchase_ImmutableNullObjectTests
    { 
        [TestInitialize]
        ...
        public void Purchase_SeleniumTestingToolsCookbook()
        {
            ...
            var purchaseContext = new PurchaseContext(UiPurchasePromotionalCodeStrategy.NULL,
