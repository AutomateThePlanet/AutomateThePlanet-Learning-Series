...
namespace BehavioursDesignPattern.Pages.ShippingAddressPage
{
    public partial class ShippingAddressPage : BasePage
    {
        ...
        public void FillShippingInfo(BehavioursDesignPattern.Data.ClientPurchaseInfo clientInfo)
        {
            this.FillAddressInfoInternal(clientInfo);
        }

        public void ClickDifferentBillingCheckBox(BehavioursDesignPattern.Data.ClientPurchaseInfo clientInfo)
        {
        ...
        public void FillBillingInfo(BehavioursDesignPattern.Data.ClientPurchaseInfo clientInfo)
        {
            if (clientInfo.BillingInfo != null)
            {
                this.FillAddressInfoInternal(clientInfo);
        ...
        private void FillAddressInfoInternal(BehavioursDesignPattern.Data.ClientPurchaseInfo clientInfo)
        {
