...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class NotEqual<T> : BaseBuiltInComparativeOperator<T>
    {
        ...
        public NotEqual(string symbol) : this(symbol, false)
        {
        }
        ...
        public NotEqual(string symbol, bool ignoreCase) : this(symbol, ignoreCase, OperatorIndependency.Strong, null)
        {
        }
        ...
        {
            return new NotEqual<T>(this.Symbol, this.ignoreCase, this.Independency, this.Description);
        }
        ...
        protected internal override Expression Compare(Operand left, Operand right)
        {
            ...
            {
                result = Expression.NotEqual(left.Expression, right.Expression);
            }
            else
            {
                ...
                {
                    result = Expression.NotEqual(l, r);
                }
            }
