...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class GreaterThan<T> : BaseBuiltInComparativeOperator<T>
    {
        /// <summary>
        /// Initializes a new instance of this class.
        /// </summary>
        /// <param name="symbol">The symbol of this operator.</param>
        public GreaterThan(string symbol) : this(symbol, OperatorIndependency.Strong, null)
        {
        }
        ...
        public GreaterThan(string symbol, OperatorIndependency independency, string description) : base(symbol, independency, description)
        {
        }
        ...
        {
            return new GreaterThan<T>(this.Symbol, this.Independency, this.Description);
        }
        ...
        protected internal override Expression Compare(Operand left, Operand right)
        {
            ...
            {
                result = Expression.GreaterThan(left.Expression, right.Expression);
            }
            else
            {
