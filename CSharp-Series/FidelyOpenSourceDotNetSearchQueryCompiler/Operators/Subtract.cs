...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class Subtract : BaseBuiltInCalculatingOperator
    {
        ...
        public Subtract(string symbol, int priority) : this(symbol, priority, OperatorIndependency.Strong, null)
        {
        }
        ...
        public Subtract(string symbol, int priority, OperatorIndependency independency, string description) : base(symbol, priority, independency, description)
        {
        }
