...
namespace Fidely.Framework.Compilation.Objects.Operators
{
    ...
    public class LessThanOrEqual<T> : BaseBuiltInComparativeOperator<T>
    {
        /// <summary>
        /// Initializes a new instance of this class.
        /// </summary>
        /// <param name="symbol">The symbol of this operator.</param>
        public LessThanOrEqual(string symbol) : this(symbol, OperatorIndependency.Strong, null)
        {
        }
        ...
        public LessThanOrEqual(string symbol, OperatorIndependency independency, string description) : base(symbol, independency, description)
        {
        }
        ...
        {
            return new LessThanOrEqual<T>(this.Symbol, this.Independency, this.Description);
        }
        ...
        protected internal override Expression Compare(Operand left, Operand right)
        {
            ...
            {
                result = Expression.LessThanOrEqual(left.Expression, right.Expression);
            }
            else
            {
