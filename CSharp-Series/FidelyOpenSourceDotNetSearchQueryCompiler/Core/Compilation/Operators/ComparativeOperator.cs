...
namespace Fidely.Framework.Compilation.Operators
{
    ...
    public abstract class ComparativeOperator : FidelyOperator
    {
        ...
        protected ComparativeOperator(string symbol) : this(symbol, OperatorIndependency.Strong)
        {
        }
        ...
        protected ComparativeOperator(string symbol, OperatorIndependency independency) : base(symbol, independency)
        {
        }
